    ...
    <div>
      ...
      <div className="container">
        <p className='topPera'> <span>Eagle Eye Security Agency</span>  is Bangladesh’s premium security services company. But what sets us apart is our diligent, incessant pursuit of excellence in our work.</p><br />
          ...
          <div className="firstPera">
            <h2 className='chooseUsHeading'>Expertise & Diligence</h2>
            <p className='aboutperagraph'>We provide the widest range of security solutions across all 64 districts of Bangladesh, as well as maintaining a steady international clientele. Our operations are coordinated by the very best of military trained, professional and a dexterous workforce.</p>
            <div className="whyusImage"><img src="https://images.pexels.com/photos/6105483/pexels-photo-6105483.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" /></div>
          </div>
          ...
          <div className="fourthPera">
            <h2 className='chooseUsHeading'>Our Vigilance</h2>
            <p className='aboutperagraph'>Eagle Eye Security Service operates around the clock, every day of the year. You can count on us for prompt, rapid service at any hour.
